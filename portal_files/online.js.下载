$(function() {
    ...
    if(!$('html.no-online').length){
        online_html+= '<li><button type="button" class="btn btn-icon btn-info btn-squared" id="btn-meqia" onclick="_MEIQIA._SHOWPANEL()"><i class="fa fa-commenting" aria-hidden="true"></i></button></li>';
        if($('#indexFeed').length) online_html+= '<li><button type="button" class="btn btn-icon btn-info btn-squared feed-online" data-toggle="modal" data-target="#indexFeed" data-backdrop="false"><i class="icon fa-pencil" aria-hidden="true"></i></button></li>';
    }
    online_html+= '<li><button type="button" class="btn btn-icon btn-info btn-squared met-scroll-top" onclick="goTop()"><i class="icon wb-chevron-up" aria-hidden="true"></i></button></li></ul></div>';
